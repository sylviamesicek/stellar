use super::{DesignTokens, UiExt as _};
use egui::style::WidgetVisuals;
use egui::{CornerRadius, IntoAtoms, Style};
...
pub struct Button<'a> {
    pub variant: Variant,
    pub size: Size,
    pub inner: egui::Button<'a>,
}

impl<'a> Button<'a> {
    pub fn new(atoms: impl IntoAtoms<'a>) -> Self {
        Self::from_button(egui::Button::new(atoms).image_tint_follows_text_color(true))
    }

    pub fn from_button(button: egui::Button<'a>) -> Self {
        Button {
            inner: button,
            size: Size::Normal,
...
pub trait ButtonExt<'a> {
    fn primary(self) -> Button<'a>;
    fn secondary(self) -> Button<'a>;
}

impl<'a> ButtonExt<'a> for egui::Button<'a> {
    fn primary(self) -> Button<'a> {
        Button::from_button(self).primary()
    }

    fn secondary(self) -> Button<'a> {
        Button::from_button(self).secondary()
    }
}
